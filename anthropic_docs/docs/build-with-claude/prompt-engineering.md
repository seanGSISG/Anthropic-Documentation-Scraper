...
Last fetched: 2025-11-05T13:15:36.968998
...
For an overview of Claude 4.5’s new capabilities, see
What’s new in Claude 4.5
. For migration guidance from previous models, see
Migrating to Claude 4.5
.
​
General principles
...
: When a context window is cleared, consider starting with a brand new context window rather than using compaction. Claude 4.5 models are extremely effective at discovering state from the local filesystem. In some cases, you may want to take advantage of this over compaction. Be prescriptive about how it should start:
...
: Git provides a log of what’s been done and checkpoints that can be restored. Claude 4.5 models perform especially well in using git to track state across multiple sessions.
